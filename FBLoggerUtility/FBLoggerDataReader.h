...
public:
    ...
    struct SanityChecks
    {
        ...
        double heatFluxMin = -5.0;
        double heatFluxMax = 150.0;
        double heatFluxTemperatureMin = -40.0;
        double heatFluxTemperatureMax = 1400.0;
        double heatFluxTemperatureVoltageMin = 0.0;
        double heatFluxTemperatureVoltageMax = 1.24999;
        double heatFluxVoltageMin = 0.0;
        double heatFluxVoltageMax = 2.5;
        double NAMin = IGNORE_MIN;
        double NAMax = IGNORE_MAX;
        double pressureVoltageMin = 0.0;
        double pressureVoltageMax = 2.5;
        double pressureMin = -797.0;
        double pressureMax = 797.0;
        double temperatureMin = -40.0;
        double temperatureMax = 1400.0;
        double velocityMin = -36.0;
        double velocityMax = 36.0;
