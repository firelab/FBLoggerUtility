...
int main() {
    ...
    double pressureXvoltage = 1.69232;
    double pressureYvoltage = 0.885473;
    double pressureZvoltage = 0.917919;
//    double pressureXvoltage = 1.58519351460834;
//    double pressureYvoltage = 1.58519351460834;
//    double pressureZvoltage = 1.265;
    ...
    if (Convert.convert(temperature, pressureXvoltage, pressureYvoltage, pressureZvoltage, sensorBearing, pressureCoefficients_, angles_, ReynoldsNumbers_) == true)
        printf("Conversion successful\nu = %lf\nv = %lf\nw = %lf\nspeed = %lf\n", Convert.u, Convert.v, Convert.w, sqrt(Convert.u*Convert.u+Convert.v*Convert.v+Convert.w*Convert.w));
    else
